...
module "policies_firehose" {
  source              = "./policies/firehose"
  environment         = var.environment
}
...
################################################################
# Criando todos os usuarios necessarios para o projeto.
################################################################
module "users" {
  source = "./users"
...
module "attachments" {
  ...
  firehose_access_policy_arn      = module.policies_firehose.firehose_access_arn
}
